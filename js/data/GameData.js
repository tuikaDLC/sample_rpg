...
const gameData = {
    ...
    dialogs: {
        ...
        'ending': [
            ...
            {
                text: 'ゲームクリア！プレイしていただきありがとうございました！'
            }
        ],
        // ダンジョンの宝箱
        'dungeon_chest_1': [
            {
                text: '宝箱を開けた！ハイポーション x2 を手に入れた！'
            }
        ],
        'dungeon_chest_2': [
            {
                text: '宝箱を開けた！500ゴールドを手に入れた！'
            }
        ],
        'dungeon_chest_3': [
            {
                text: '宝箱を開けた！鋼の剣を手に入れた！'
            }
        ],
        'dungeon_chest_4': [
            {
                text: '宝箱を開けた！ハイエーテル x3 を手に入れた！'
            }
        ],
        // エリア発見メッセージ
        'dungeon_entrance': [
            {
                text: 'システム：闇のダンジョンに到達した'
            },
            {
                text: 'システム：ここから先は強敵が待ち受けている。準備を整えてから挑もう'
            },
            {
                text: 'システム：ダンジョンはB1からB5まで5階層ある。最深部には魔王が待ち受けている'
            }
        ],
        'dungeon_b2_entrance': [
            {
                text: 'システム：ダンジョンB2階に到達した'
            },
            {
                text: 'システム：敵がより強力になっている。慎重に進もう'
            }
        ],
        'dungeon_b3_entrance': [
            {
                text: 'システム：ダンジョンB3階に到達した'
            },
            {
                text: 'システム：中間地点だ。ここまで来れば折り返し地点'
            }
        ],
        'dungeon_b4_entrance': [
            {
                text: 'システム：ダンジョンB4階に到達した'
            },
            {
                text: 'システム：最深部が近い。気を引き締めよう'
            }
        ],
        'dungeon_b5_entrance': [
            {
                text: 'システム：ダンジョンB5階（最深部）に到達した'
            },
            {
                text: 'システム：ボス部屋への階段が見える。最終決戦の準備はできているか？'
            }
        ],
        'boss_room_entrance': [
            {
            ...
            {
                text: 'システム：部屋の奥に強大な気配を感じる...'
            },
            {
                text: 'システム：引き返すなら今のうちだ'
            }
        ],
        'cave_entrance': [
            {
                text: 'システム：水晶の洞窟を発見した'
            },
            {
                text: 'システム：初心者向けのダンジョンだ。レベル上げに最適'
            }
        ],
        'castle_entrance': [
            {
                text: 'システム：忘れられた古城を発見した'
            },
            {
                text: 'システム：かつて栄華を誇った城も、今は魔物の巣窟となっている'
            }
        ],
        'tower_entrance': [
            {
            ...
            {
                text: 'システム：最上階には強力な魔道士が待ち受けているという'
            }
        ],
        'tower_boss': [
            {
                text: 'リッチ「よくぞここまで辿り着いた...だが貴様の命もここまでだ」'
            },
            {
                text: 'リッチ「我が魔法の力、見せてやろう！」',
                event: {
                    type: 'battle',
                    enemyId: 'lich'
                }
